...
function updateStudentGrade(studentsArray, idToUpdate, newGrade) {
    ...
    const index = students.findIndex(i => i.id == idToUpdate);
  ...
  if (index !== -1) {
    ...
    updateStudentArray[index] = {...updateStudentArray[index], grade: newGrade};
...
//find: trả về tìm kiếm đầu tiên, filter: trả về tất cả phù hợp với đk, findIndex: trả về chỉ mục
//toán tử trải rộng: lấy tất cả của đối tượng mình muốn lấy (...)